...
return [
    ...
    'dimmer' => [
        'page'           => 'Page|Transcation',
        'page_link_text' => 'View all Transcation',
        'page_text'      => 'You have :count :string in your database. Click on button below to view all Transcation.',
        'post'           => 'Post|Posts',
